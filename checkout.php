    ...
    if (empty($payment_method) || empty($name) || empty($address) || empty($city) || empty($phone)) {
        ...
        try {
            ...
            foreach ($cart_items as $product) {
                ...
                if ($order_stmt = $conn->prepare($insert_order_query)) {
                    ...
                    if ($payment_stmt = $conn->prepare($insert_payment_query)) {
                        ...
                        if ($cart_stmt = $conn->prepare($delete_cart_query)) {
        ...
        <?php if (!empty($cart_items)): ?>
            ...
            <form method="POST" onsubmit="return validateForm()">
                <div class="payment-options">
                    ...
                    <input type="radio" id="online" name="payment_method" value="Online Payment" class="payment-method">
                    <label for="online" class="payment-label">Online Payment</label>
                </div>

                <div id="payment-details" class="payment-details" style="display: block;">
                    <h3 id="payment-title">Cash on Delivery</h3>
                    <p>You will pay ₨ <?php 
                        $total_amount = 0;
